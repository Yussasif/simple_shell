...
Install and Compile
```
(your_terminal)$ git clone https://github.com/yussasif/simple_shell.git
...
$ ls -al
total 4
-rw-rw-r-- 1 vagrant vagrant   234 May 17 19:32 file1.c
-rw-rw-r-- 1 vagrant vagrant    69 May 17 19:32 file2.c
...
---
### Authors
Owoade Yusuf (https://github.com/yussasif) <yusufowoade2@gmail.com>
Okor Mark (https://github.com/Holic65) <okormark@gmail.com>
